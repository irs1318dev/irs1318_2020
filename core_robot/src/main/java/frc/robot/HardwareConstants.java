...
public class HardwareConstants
{
    ...
    public static final double DRIVETRAIN_LEFT_ENCODER_PULSES_PER_REVOLUTION = 1.0;
    ...
    public static final double DRIVETRAIN_RIGHT_ENCODER_PULSES_PER_REVOLUTION = 1.0;
