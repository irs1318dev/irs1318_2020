 ...
 * 
 */
public class IncreaseFlyWheelSpeedTask extends TimedTask implements IControlTask
{
     ...
     */
    public IncreaseFlyWheelSpeedTask(double duration, double velocityAmount)
    {
        super(duration);
