...
public class DriveTrainMechanism implements IMechanism
{
        ...
        ITimer timer)
    {
        ...
        this.leftMotor = provider.getVictorSPX(ElectronicsConstants.DRIVETRAIN_LEFT_MASTER_CAN_ID);
        ...
        ITalonFX leftFollowerMotor1 = provider.getVictorSPX(ElectronicsConstants.DRIVETRAIN_LEFT_FOLLOWER_CAN_ID);
        ...
        this.rightMotor = provider.getVictorSPX(ElectronicsConstants.DRIVETRAIN_RIGHT_MASTER_CAN_ID);
        ...
        ITalonFX rightFollowerMotor1 = provider.getVictorSPX(ElectronicsConstants.DRIVETRAIN_RIGHT_FOLLOWER_CAN_ID);
