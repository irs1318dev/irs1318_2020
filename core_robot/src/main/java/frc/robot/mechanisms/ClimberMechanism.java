...
public class ClimberMechanism implements IMechanism
{
    ...
    public ClimberMechanism(IRobotProvider provider)
    {
        ...
        this.climberGrabSolenoid = provider.getDoubleSolenoid(ElectronicsConstants.PCM_B_MODULE, ElectronicsConstants.CLIMBER_GRAB_FORWARD_PCM, ElectronicsConstants.CLIMBER_GRAB_REVERSE_PCM);
